...
## 🟢 ทิศทางปัจจุบัน (D-76 · 2026-09-02) — อ่านก่อนอย่างอื่น
...
- **เหลือทำตอนนี้:** **D-70** (หน้าสรุปต้นทุนจาก `ai_usage` — มี call_kind assistant แยกแล้ว) → **D-71** (explicit caching ถ้า cached_tokens=0) · ซ้อม **บท 2 / 4 / 5** · เฝ้าอาการ "คำถามขึ้นต้นบอลลูนปิด" (ยังไม่นิ่ง)
