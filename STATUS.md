...
- **D-52 ป้ายช่องทาง เสร็จ ✅** บน `main` — `channelLabel` (`[FB]`/`[ซ้อม]`/`[LINE]`) หน้าชื่อลูกค้าในข้อความแอดมินทุกจุด (handoff/ออเดอร์/list/D-50) · แอดมินเห็นช่องทางทันที · **420 passed**
