...
- 🔴 **แต่ 18/18 ผ่านเพราะ "guard" ไม่ใช่เพราะ "prompt" → C3 จำเป็น (ยังข้ามไม่ได้)**
  - assurance guard บน `aa0f658`: **hit 5 ใน 6 เทิร์นสุขภาพ (83%)** · regenerate สะอาด **2/5** · ที่เหลือ **3 เทิร์นต้องตัดบรรทัดทิ้ง** (ลูกค้าถามเรื่องแพ้อาหารแล้วได้คำตอบไม่ครบ)
  - regen แกว่ง **40–83% ข้ามรอบ** (2/5 บน `aa0f658` · 5/6 บน prompt เวอร์ชันระหว่างทางที่ไม่ได้ ship · 1/4 ก่อน C2) — ไม่มีแนวโน้มนิ่ง
  - prompt v3 ยังผลิต "ปลอดภัย"/"ทานได้" แทบทุกเทิร์นสุขภาพ · guard = ด่านสุดท้ายก่อนถึงลูกค้า ทำงาน 5/6 ครั้ง **ไม่มี margin เหลือ** (H1 หลุด = คดี ไม่ใช่บั๊ก)
  - **เป้า C3 (Fable · โซนสุขภาพใน prompt v3): ลด hit rate ให้ prompt ไม่ผลิตคำรับรองตั้งแต่แรก** แล้วให้ guard เป็นตาข่ายสำรองจริง ไม่ใช่ทางเดินหลัก
