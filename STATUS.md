...
## 🟢 ทิศทางปัจจุบัน (D-72b · 2026-09-02) — อ่านก่อนอย่างอื่น
...
- 🟢 **ปุ่มเขียนใน /train เปิดแล้ว (D-72b)** — `assertWritable()` ถูกถอด · พิกัดเขียนมาจากแถวดิบ (`loadRawSheets`) · ⚠️ รอเจ้าของพิสูจน์ด้วยมือบนชีตจริง 1 รอบ
...
- **เหลือทำตอนนี้:** **D-70** (เปิด intake D-34/35 กลับ) · ซ้อม **บท 2 / 4 / 5** · เฝ้าอาการ "คำถามขึ้นต้นบอลลูนปิด" (ยังไม่นิ่ง)
