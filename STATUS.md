...
- ⚠️ **ช่องที่ยังเหลือของ C5:** "choice close แยกเป็นบอลลูนของตัวเอง" ยังไม่สำเร็จ — โมเดลผูก "รายการโปร + คำถาม" ไว้บอลลูนเดียว แม้ดัน prompt 2 รอบ · ถ้าต้องการเป๊ะ = บังคับที่ delivery layer (`deliverReply` ตัดคำถามท้ายออกเป็นบอลลูนใหม่) → DECISIONS D-61.C5
