...
- **โมเดล: เลือกจากลักษณะงานตอนมอบหมาย** (ดู [CLAUDE.md](../CLAUDE.md) §เลือกโมเดล) — **Fable**: วินิจฉัยพฤติกรรม AI/prompt engineering · ออกแบบข้ามหลายระบบ · แตะ invariants หลายชั้น · debug ที่อาการ-สาเหตุไม่เชื่อมกัน (เช่น T2-จ1/จ2 ตัวผู้ช่วย · D-60.2) · **Opus**: contract ชัด/UI/CRUD/แก้บั๊กที่รู้สาเหตุ (เช่น T2-ก/ข/ฉ/ง) · เจ้าของระบุโมเดลกำกับตอนสั่ง · แยกก้อนงานตามโมเดล (สลับได้ระดับ session)
