# T2-STUDIO-SPEC — T-STUDIO v2: ศูนย์บัญชาการปลาทู `[ก ✅ · ข-จ UNBUILT]`
...
## เฟส T2-ข · สวิตช์เปิด-ปิดบอทใน UI (เล็ก · ต่อยอด D-53 ตรงๆ)
...
- ลำดับ build: **ก → ข → ค → ง → จ** (คุณค่าเร็ว→ช้า · เสี่ยงต่ำ→สูง) · หยุดพักระหว่างเฟสได้ทุกจุด — แต่ละเฟสจบในตัว
