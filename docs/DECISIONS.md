...
| โมเดล | input | output | cached input | storage/ชม. |
|---|---|---|---|---|
| **gemini-3.5-flash** (ใช้อยู่) | **$1.50** | **$9.00** | $0.15 | $1.00 |
| gemini-3.6-flash | $0.75 | $3.75 | $0.075 | $0.50 |
| gemini-3.7-flash | $0.75 | $3.75 | $0.075 | $0.50 |

**3.5-flash แพงที่สุดในสามตัว** — input 2 เท่า · output 2.4 เท่า · ประเมิน: 3.5 ≈ 0.54 บาท/เทิร์น → 3.7 ≈ 0.27 (−50%) → 3.7+cache ≈ 0.19 (−65%)
⚠️ ราคา 3.6/3.7 เป็น **โปรถึง 31 ธ.ค. 2026** หลังจากนั้นขึ้นเป็น 2 เท่า
...
#### 🔴 3 · เจ้าของเคาะแล้ว: จะเปิด intake D-34/35 กลับมา = **งาน D-70** (หลัง D-69)
