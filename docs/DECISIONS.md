...
- **ส่วน 2 · system prompt ผู้ช่วย (`buildAssistantSystem`):** +กติกา **11 flow สัมภาษณ์** (เทิร์นแรกงานใหม่ reply-only ถาม → จังหวะ2 ร่าง 3 แบบเต็มคุณภาพ ผสม 3 องค์ประกอบ ต่างที่น้ำหนัก → จังหวะ3 proposal เดียว · ยกเว้นข้อมูลครบ/แก้เล็ก) · **12 เสียงนักขาย CX** (ระบุความกังวลก่อน · นักแก้ปัญหา+สร้างทางเลือก · ขจัดด้วยข้อเท็จจริง · นำพา step ถัดไป · เส้นห้าม สุขภาพ/claims) · **persona ค่ะ/นะคะ เท่านั้น** (ห้าม ครับ/ผม) · note ≥2 เคสจริง
