...
🔴 **`gemini-2.5-*` ห้ามใช้** (Google ปิด 16 ต.ค. 2026 · ข้อมูลจากเจ้าของ — หน้า pricing ยังไม่ประกาศ) · คงราคาไว้ในตารางโค้ดเพื่อความครบ (อ่าน log เก่าย้อนหลัง) + `warnIfDeprecatedModel` เตือนดังถ้าตั้งในชีต · ราคาถูกกว่าก็จริงแต่**หมดอายุก่อน** — ย้ายไปแล้วต้องย้ายอีกรอบ
