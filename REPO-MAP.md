...
> 🔴 **D-47:** payment pre-check (มี items+ยังไม่มีวิธีจ่าย → คำจ่ายล้วน ข้าม AI · พ่วงอื่น ล็อก payment ทับ) ก่อนเรียก Gemini · redact เลขบัญชี/เบอร์ ใน history/state input · `runSalesTurn` retry 1 ครั้งเมื่อ blocked
