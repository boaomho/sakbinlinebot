...
const STEPS: string[][] = [
  ...
  // D-58: ชีตใหม่ H1 = handoff_notify (บอทตอบข้อมูลปลอดภัย + แจ้งแอดมิน + ไม่ปิดบอท) · เข้าผ่าน pre-check คำ_notify หรือ AI routing
  s("H1", "handoff_notify", "สุขภาพ-แพ้อาหาร", "เสี่ยงสุขภาพ", 'แพ้อาหาร/โรค/เด็ก/คนท้อง/ยา เช่น "แพ้กุ้ง" "ลูกกินได้มั้ย" "เป็นเบาหวาน"', ""),
...
function pipeSteps(): string[][] {
  return [
    ...
    // D-58: H1 = handoff_notify → บอทตอบ pattern นี้ + แจ้งแอดมิน 🔔 + ไม่ปิดบอท (คำตอบปลอดภัย: ให้ข้อมูล+ปรึกษาแพทย์ ไม่รับรอง)
    ps("H1", "handoff_notify", "สุขภาพ", 'แพ้อาหาร/โรค/ยา เช่น "แพ้กุ้ง"', "สินค้ามีส่วนผสมปลาและกะปิค่ะ หากมีข้อสงสัยเรื่องแพ้อาหาร แนะนำปรึกษาแพทย์ เดี๋ยวแอดมินมาช่วยดูแลเพิ่มเติมนะคะ", ""),
