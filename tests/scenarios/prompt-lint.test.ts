...
describe("prompt/system.ts — order_data = items · ราคายึดตาราง (D-18)", () => {
  ...
  it("ยังต้องมีกฎ 'หยิบเลขจากตารางราคา ห้ามคำนวณเอง' (C6 · D-24)", () => {
    expect(src, "ต้องมีกฎยึดตารางราคา").toMatch(/ตารางราคา|ห้ามคิดเลขนอกตาราง|ห้ามคิดเลขเอง/);
    expect(src, "ต้องห้ามบอทคำนวณ/ปัดเศษเอง").toMatch(/ห้ามคำนวณ|ห้ามคิดเลข|ห้ามปัดเศษ/);
  });
});
