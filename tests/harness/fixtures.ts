...
export function testConfig(overrides: Partial<AppConfig> = {}): AppConfig {
  const raw = new Map<string, string>([
    ...
    // pricing (D-15) — lib/core/pricing อ่านจาก config.raw · ค่าจริงจากชีต
 ...
 */
// D-15: order_data มีแค่ 3 ช่องผู้รับ (+ items) · ที่อยู่ก้อนเดียว ไม่มีช่องจังหวัด/รหัสแยก
 ...
 * → addressComplete เดิมบังคับ ต./อ./จ. → complete=false ตลอด → ออเดอร์หายเงียบ
 */
